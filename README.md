...
```shell
git clone https://github.com/ColePBryan/ColePBryan.github.io
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/ColePBryan.github.io/` (actual URL will be outputted in the CLI) in a browser.
...
links:
  - github: https://github.com/ColePBryan/ColePBryan.github.io
  - link: https://github.com/ColePBryan/ColePBryan.github.io#readme
